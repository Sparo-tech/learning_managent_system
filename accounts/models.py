...
class Class_level(models.Model):
    ...
    class Meta:
        verbose_name = _("class_level")
        verbose_name_plural = _("class_levels")
...
class Lecture_session(models.Model):
    ...
    class Meta:
        verbose_name = _("lecture_session")
        verbose_name_plural = _("lecture_sessions")
